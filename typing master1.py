...
def newwin():
    ...
    def dift():
        ...
        lab4.config(text=err)
    def comp():
        global stdata,totalchar
        global err,submit1,stinput
        if submit1==0:
        ...
        submit1=1
    def clear():
        global submit1,gross_wpm,net_wpm,accu,totalchar,err
        totalchar=0
        err=0
        gross_wpm=0.0
        net_wpm=0.0
    ...
    drop.place(x=2,y=20)
    selectlesson=tk.Label(window,text="Select Lesson:")
    selectlesson.place(x=0,y=3)
    selectday=tk.Label(window,text="Select Day")
    selectday.place(x=90,y=3)
    button=tk.Button(window,text="Select",command=show)
    button.place(x=180,y=6)
    submit=tk.Button(window,text="Submit",width=10,height=3,command=comp)
    submit.place(x=900,y=500)
    text=tk.Text(window,bg="white",fg="black",width=70,height=20)
    text.place(x=230,y=25)
    
    label3=tk.Label(window,text="Start Typing")
    label3.place(x=230,y=360)
    label10=tk.Label(window,text="Exercise")
    label10.place(x=230,y=3)
    textinput=tk.Text(window,bg="white",fg="black",width=70,height=19)
    textinput.place(x=230,y=380)
    lab=tk.Label(text="Gross Wpm :")
    lab.place(x=880,y=10)
    label=tk.Label(window)
    label.place(x=960,y=10)
    lab1=tk.Label(text="Net Wpm :")
    lab1.place(x=880,y=30)
    lab2=tk.Label(text="Accuracy")
    lab2.place(x=880,y=50)
    lab3=tk.Label(text="Error :")
    lab3.place(x=880,y=70)
    lab4=tk.Label(window)
    lab4.place(x=960,y=70)
    label1=tk.Label(window)
    label1.place(x=960,y=30)
    label2=tk.Label(window)
    label2.place(x=960,y=50)
    window.mainloop()
