...
def amount50():
        ...
        global aa
        aa=int(input("Enter Ticket Number 1-10 :"))
        print("--------------------------------------------")
        
        global b
        b=input("Enter Second Person :")
        global bb
        bb=int(input("Enter Ticket Number 1-10 :"))
        print("--------------------------------------------") 
        
        global c
        c=input("Enter Third Person :")  
        global cc
        cc=int(input("Enter Ticket Number 1-10 :"))
        print("--------------------------------------------")
        
        global d
        d=input("Enter Fourth Person :")
        global dd
        dd=int(input("Enter Ticket Number 1-10 :"))
        print("--------------------------------------------")
        for i in range(3):
           global z
...
def amount100():
    ...
    global p
    p=int(input("Enter Ticket Number 1-10 :"))
    print("--------------------------------------------")

    global bc
    bc=input("Enter Second Person :")
    global v
    v=int(input("Enter Ticket Number 1-10 :"))
    print("--------------------------------------------")

    global cd
    cd=input("Enter Third Person :")  
    global w
    w=int(input("Enter Ticket Number 1-10 :"))
    print("--------------------------------------------")

    global de
    de=input("Enter Fourth Person :")
    global y
    y=int(input("Enter Ticket Number 1-10 :"))
    print("--------------------------------------------")

    for i in range(3):
        global rz
        rz=random.randint(1,10) 
        print("Random Number :",rz)
...
def amount500():
    ...
    global s
    s=int(input("Enter Ticket Number 1-10 :"))
    print("--------------------------------------------")

    global bg
    bg=input("Enter Second Person :")
    global j
    j=int(input("Enter Ticket Number 1-10 :"))
    print("--------------------------------------------")

    global ck
    ck=input("Enter Third Person :")  
    global k
    k=int(input("Enter Ticket Number 1-10 :"))
    print("--------------------------------------------")
    
    global dq
    dq=input("Enter Fourth Person :")
    global l
    l=int(input("Enter Ticket Number 1-10 :"))
    print("--------------------------------------------")

    for i in range(3):
        global zq
        zq=random.randint(1,10) 
        print("Random Number :",zq)
